...
export function Footer() {
	return (
		<>
			<footer className="container max-w-[1320px] md:hidden mx-auto px-4 text-white rounded-t-3xl pt-15 mt-15 pb-8 bg-black">
			...
			<footer className="hidden md:block bg-black text-white py-[80px] mt-[168px] rounded-t-3xl">
