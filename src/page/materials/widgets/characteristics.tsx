  ...
  return (
    <section className="container max-w-[1320px] mt-15 md:mt-30 mx-auto px-4">
      ...
      <div className="mt-10">
        ...
        <div className="w-full hidden md:flex flex-col mt-4 md:flex-row md:justify-between gap-4">
          <div className="bg-[#F3F3F3] w-full md:max-w-[427px] rounded-3xl flex flex-col gap-2 px-4 pb-32 md:p-7 md:pb-15 py-5">
            <Image
        ...
        <Slider
          items={[
            <div className="bg-[#F3F3F3] w-full md:max-w-[427px] h-[206px] rounded-3xl flex flex-col gap-2 px-4 pb-32 md:p-7 md:pb-15 py-5">
              <Image
                src={"/materials/scales.svg"}
                alt="scales"
                width={32}
              ...
              <p className="text-[14px] md:text-base">
                В 7 раз легче натурального камня. Не требует усиления
                фундамента.
              </p>
            </div>,
            <div className="bg-[#F3F3F3] w-full md:max-w-[427px] h-[206px] rounded-3xl flex flex-col gap-2 px-4 pb-12 py-5 md:p-7 md:pb-15">
              <Image
                src={"/homepage/rock.svg"}
                alt="scales"
                width={32}
              ...
              <p className="text-[14px] md:text-base">
                Молотый мрамор и доломит. Визуально идентичен натуральному
                камню.
              </p>
            </div>,
