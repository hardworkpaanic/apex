	...
	return (
		<section className="bg-[url('/materials/production.jpg')] text-white rounded-t-3xl bg-cover w-full bg-center pt-15 py-5 md:py-20 bg-no-repeat ">
			<div className="container max-w-[1320px] mx-auto px-4">
				...
				<div className="mt-10 flex flex-col gap-5 md:flex-row md:justify-between md:gap-5 md:flex-wrap md:mt-20">
					...
					<div className="bg-linear-to-r md:max-w-[400px] w-full from-[#444444]/99 to-[#000000] p-5 flex flex-col md:justify-between md:h-[164px] text-white rounded-2xl md:mt-0 mt-5">
						<Flame />
