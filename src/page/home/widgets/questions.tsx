				...
				>
					...
					>
						<AccordionTrigger className="text-[16px] md:text-[18px] font-semibold">
							Сколько стоит фасадный декор для дома 300 м²?
						</AccordionTrigger>
						<AccordionContent>
					...
					>
						<AccordionTrigger className="text-[16px] md:text-[18px] font-semibold">
							Чем полимербетон отличается от натурального камня?{' '}
						</AccordionTrigger>
						<AccordionContent>
							Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus
							aliquam nostrum deserunt ipsum quod voluptatem tenetur. Nisi,
					...
					>
						<AccordionTrigger className="text-[16px] md:text-[18px] font-semibold">
							Работаете ли вы только в Москве?
						</AccordionTrigger>
						<AccordionContent>
							Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus
							aliquam nostrum deserunt ipsum quod voluptatem tenetur. Nisi,
