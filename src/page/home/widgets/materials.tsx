    ...
    <section className="container max-w-[1320px] md:pt-[120px] pb-[108px] mt-12.5 mx-auto px-4 flex  flex-col">
        ...
        <div className="flex flex-col justify-center gap-5">
          ...
          <div className="flex sm:hidden gap-5 flex-col">
            <div className="flex justify-between items-center">
              <div className="flex justify-center w-[166px] flex-col items-center gap-3">
                <Image
      ...
      <div className="w-full mt-[110px] hidden md:flex justify-between">
        <div className="flex justify-center flex-col items-center gap-3">
          <Image src="/homepage/rock.svg" alt="rock" width={48} height={48} />
        ...
        <div className="flex justify-center flex-col items-center gap-3">
          <Image src="/homepage/snow.svg" alt="snow" width={48} height={48} />
        ...
        <div className="flex justify-center flex-col items-center gap-3">
          <Image src="/homepage/time.svg" alt="time" width={48} height={48} />
