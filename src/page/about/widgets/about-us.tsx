  ...
  return (
    <section className="container max-w-[1320px] mt-15 md:mt-30 mx-auto px-4">
      <div className="flex flex-col md:flex-row md:justify-between">
        <div className="">
          <Image
            ...
            unoptimized
          />
          <h2 className="font-semibold text-[30px] flex items-center md:text-[48px] leading-[110%]">
            О компании{" "}
            <Image
              src={"/logo.svg"}
              width={121.4522933959961}
              height={36}
              alt="Logo"
              className="mt-0.75 ml-3"
              unoptimized
            />
          </h2>
      ...
      <div className="w-full justify-center mt-10 md:mt-30 text-center items-center">
        <h2 className="font-semibold relative text-[22px] md:text-[48px] md:font-bold leading-[110%] text-center">
          <Image
            src={"/logo.svg"}
            width={121.4522933959961}
            height={36}
            alt="Logo"
            className="mt-0.75 absolute top-2 hidden md:block left-82 ml-3"
            unoptimized
          />{" "}
          <span className="md:opacity-0 opacity-100">Apex</span> в цифрах —
          факты, <br /> которым можно доверять
        </h2>
      </div>
