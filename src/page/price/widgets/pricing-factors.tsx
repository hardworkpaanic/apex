  ...
  return (
    <section className="mt-15 md:mt-30">
      <div className="container max-w-[1320px] mx-auto px-4">
        ...
        <div className="bg-linear-to-r w-full h-full md:max-w-[315px] md:h-[253px] from-[#444444]/99 to-[#000000] p-5 flex flex-col justify-between text-white rounded-2xl mt-5">
          <Flame />
