      ...
      <div className="mx-auto px-4 max-w-[1330px] container">
        ...
        <div className="flex flex-col mt-10 w-full">
          <div className="flex flex-col w-full md:border-b  md:border-white/30 md:flex-row">
            {" "}
            <div className="flex flex-col mt-5 md:max-w-[433px] md:pt-5 md:px-7 w-full pb-4 md:border-none border-b border-[#919191] gap-2">
          ...
          <div className="flex flex-col md:border-b md:border-white/30 md:flex-row">
            <div className="flex md:px-7 md:border-r-1 md:pt-7 md:w-full pb-4 flex-col mt-5 md:mt-0 md:pb-10 md:border-b-0 border-b border-[#919191] gap-2">
              <span className="text-[14px] md:text-[20px] font-bold">
                Надёжнее
              </span>
              <p className="text-[14px]">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:border-r md:py-5 md:px-7 mt-4 md:mt-0 md:border-white/30">
            ...
            <ul className="flex flex-col mt-5 md:gap-9 gap-4">
              ...
              <li className="flex flex-row items-center gap-3">
                <Image src={"/temp.svg"} alt="wall" width={24} height={24} />
                <div className="flex flex-col">
                  <span className="text-[14px] font-semibold">
                    Средняя температура
                  </span>
              ...
              <li className="flex flex-row items-center gap-3">
                <Image src={"/ce.svg"} alt="wall" width={24} height={24} />
                <div className="flex flex-col">
                  <span className="text-[14px] font-semibold">
          ...
          <div className="w-full md:px-7 mt-4 md:mt-0 md:py-5">
            ...
            <ul className="flex flex-col mt-5 md:gap-9 gap-4">
              ...
              <li className="flex flex-row items-center gap-3">
                <Image src={"/wind.svg"} alt="wall" width={24} height={24} />
                <div className="flex flex-col">
                  <span className="text-[14px] font-semibold">
              ...
              <li className="flex flex-row items-center gap-3">
                <Image src={"/snow.svg"} alt="wall" width={24} height={24} />
                <div className="flex flex-col">
                  <span className="text-[14px] font-semibold">
                    Во время снегопада
                  </span>
        ...
        <div className="bg-[#1E1E1E] relative rounded-2xl gap- flex flex-col md:flex-row md:p-15 px-4 pt-5 pb-20 mt-10">
          <div className="">
            <Image
              src="/mini-logo.svg"
              alt="mini-logo"
