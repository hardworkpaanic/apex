  ...
  return (
    <>
      <section className="container  mt-15 md:mt-30 max-w-[1330px] mx-auto px-4">
        ...
        <div className="mt-5 md:mt-[54px] hidden md:gap-1 md:flex flex-col md:flex-row md:justify-between flex-wrap">
          ...
          items={[
            <div className="border border-[#EDEDED] rounded-2xl p-7 flex flex-col justify-between md:justify-start md:gap-2 w-full max-w-[428px] md:h-[323px]">
              ...
              <div className="flex flex-col md:gap-2">
                ...
                <p className="text-[12px] italic md:text-[14px]">
                  Все наши монтажники прошли обучение на производстве и знают
                  каждый нюанс материала. Каждый специалист имеет сертификат
                  APEX и опыт работы минимум 3 года. Монтажники владеют
                  технологией сухого крепления, умеют работать с узлами любой
                  сложности и знают, как достичь идеальной стыковки элементов.
                </p>
              </div>
            </div>,
            <div className="border border-[#EDEDED] rounded-2xl p-7 flex flex-col justify-between md:justify-start md:gap-2 w-full max-w-[428px] md:h-[323px]">
              ...
              <div className="flex flex-col md:gap-2">
                ...
                <p className="text-[12px] italic md:text-[14px]">
                  Технология сухого крепления позволяет монтировать элементы при
                  температуре до -15°C. Мы не используем клей или раствор,
                  поэтому не зависим от погоды. Монтаж возможен с марта по
                  декабрь без ограничений, а в январе-феврале — при
